"""
Django settings for langchainApp project.
...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", default="devkey")
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = int(os.getenv("DJANGO_DEBUG", default=True))
...
ROOT_URLCONF = "langchainApp.urls"
...
WSGI_APPLICATION = "langchainApp.wsgi.application"
